...
class Init extends Template
{
    ...
    public function getEligibleWheel(): ?WheelInterface
    {
        ...
        /**
     * Build JSON-encoded trigger configuration and escape for safe JS output.
     *
     * @return string
     */
    public function getTriggerConfig(): array
    {
        ...
        return [
            'isScrollEnabled'  => (bool) $wheel->getIsScrollEnabled(),
            'scrollPercentage' => (int)   $wheel->getScrollPercentage(),
            'isTimeoutEnabled' => (bool) $wheel->getIsTimeoutEnabled(),
            'timeoutDuration'  => (int)   $wheel->getTimeoutDuration(),
            'isExitEnabled'    => (bool) $wheel->getIsExitEnabled(),
            'oncePerSession'   => (bool) $wheel->getOncePerUser(),
            'isCtaEnabled'     => (bool) $wheel->getIsCtaEnabled(),
        ];
    }
